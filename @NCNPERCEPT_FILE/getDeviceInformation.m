...
% GETDEVICEINFORMATION Display information about device.
%
% Syntax:
...
text= [ 'Neurostimulator: ', obj.parameters.system_information.neurostimulator, newline...
    ...
    '  ', newline...
    'Accumulated Therapy On Time Since Follow-up: ', num2str(obj.parameters.system_information.accumulated_therapy_on_time_since_followup)];
